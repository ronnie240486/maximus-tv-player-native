...
class PlaylistRepository(private val context: Context) {
    ...
    // Busca imagem + sinopse de CADA episódio de uma série, usando o mesmo
    // get_series_info do Xtream (que já é chamado para a sinopse geral da
    // série, mas até aqui o campo "episodes" da resposta era ignorado).
    // Resultado fica em cache em memória por série (temporada:episódio -> detalhe).
